    ...
    <div id="select-box">
      ...
      <div id="options">
        <div class="option">
          ...
          <span class="opt-val">COMMON</span>
        </div>
        <div class="option">
          ...
          <span class="opt-val">HTML/CSS</span>
        </div>
        <div class="option">
...
.option svgnput[type='radio']:checked ~ .opt-val {
  opacity: 1;
  transform: scale(1);
}

.option svgnput[type='radio']:checked ~ i {
  top: 0;
  bottom: auto;
  opacity: 1;
  animation: unset;
...
.option svgnput[type='radio']:checked ~ i,
.option svgnput[type='radio']:checked ~ .label {
  color: #fff;
}

.option svgnput[type='radio']:checked ~ .label:before {
  content: '';
  position: absolute;
  top: 0;
  right: 0;
...
#options-view-button:not(:checked) ~ #options .option svgnput[type='radio']:checked ~ .opt-val {
  top: -30px;
}
